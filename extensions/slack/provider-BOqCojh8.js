...
import { loadConfig, loadSessionStore, resolveNativeCommandsEnabled, resolveNativeSkillsEnabled, resolveStorePath, writeConfigFile } from "openclaw/plugin-sdk/config-runtime";
...
function loadSlackMessagePipeline() {
	slackMessagePipelinePromise ??= import("./pipeline.runtime-R7VWUisB.js");
