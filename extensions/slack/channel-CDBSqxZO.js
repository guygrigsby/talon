...
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-BrHwjBkS.js").then((n) => n.t));
...
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-BV7MMc_d.js").then((n) => n.t);
