...
const defaultCodexAppServerClientFactory = (startOptions, authProfileId) => import("./shared-client-CpOyZpH5.js").then((n) => n.r).then(({ getSharedCodexAppServerClient }) => getSharedCodexAppServerClient({
	startOptions,
	authProfileId
}));
