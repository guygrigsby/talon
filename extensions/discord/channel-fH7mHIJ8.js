...
import { t as getDiscordApprovalCapability } from "./approval-native-FgN-ELcT.js";
import { t as discordMessageActions$1 } from "./channel-actions-BZNBQL75.js";
...
import { i as normalizeDiscordMessagingTarget, n as discordOutbound, r as looksLikeDiscordTargetId } from "./outbound-adapter-BAEzEthv.js";
import { t as getDiscordRuntime } from "./runtime-DwbCVZGx.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-C7qiAj23.js";
...
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-DruktLHM.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DYKsTCQW.js");
...
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DWUNzXCP.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-C5KMi0rM.js").then((n) => n.t);
