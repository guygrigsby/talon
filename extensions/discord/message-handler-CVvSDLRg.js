...
import { n as resolveDiscordReplyDeliveryPlan } from "./threading-DA2WUvjc.js";
...
async function loadMessageProcessRuntime() {
	messageProcessRuntimePromise ??= import("./message-handler.process-TPiKFEKP.js");
	return await messageProcessRuntimePromise;
}
async function loadReplyDeliveryRuntime() {
	replyDeliveryRuntimePromise ??= import("./reply-delivery-BfTXErgm.js").then((n) => n.n);
...
async function loadMessagePreflightRuntime() {
	messagePreflightRuntimePromise ??= import("./message-handler.preflight-BCuKqs0n.js");
