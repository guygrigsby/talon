...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DdHtlIaN.js").then((n) => n.i).then((module) => module.sendDiscordComponentMessage);
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-C5KMi0rM.js").then((n) => n.t);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-ChORo-MI.js").then((n) => n.t);
