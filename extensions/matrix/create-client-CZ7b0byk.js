...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DQe9zwo9.js").then((n) => n.n), import("./logging-BwMA7mvv.js").then((n) => n.n)]).then(([sdkModule, loggingModule]) => ({
