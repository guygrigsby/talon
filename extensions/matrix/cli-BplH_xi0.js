...
import { n as matrixSetupAdapter } from "./setup-core-VW6XhhCl.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-BRg3Vwaf.js").then((n) => n.t);
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BC1ubqYD.js");
