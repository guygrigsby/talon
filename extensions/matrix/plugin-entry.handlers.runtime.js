...
function loadMatrixVerificationRuntime() {
	matrixVerificationRuntimePromise ??= import("./verification-03YDFmNq.js").then((n) => n.y);
...
async function ensureMatrixCryptoRuntime(...args) {
	const { ensureMatrixCryptoRuntime: ensureRuntime } = await import("./deps-XERUPAMX.js").then((n) => n.t);
