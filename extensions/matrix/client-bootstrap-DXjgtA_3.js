...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CGRbnsL6.js").then((n) => n.t), import("./shared-Bb8tjpHS.js").then((n) => n.a)]).then(([clientModule, sharedModule]) => ({
