...
import { M as isTelegramPollingNetworkError, k as isRecoverableTelegramNetworkError } from "./send-BKGIvMhR.js";
...
async function loadTelegramActionRuntime() {
	telegramActionRuntimePromise ??= import("./action-runtime-CNSxD5xu.js");
...
async function loadTelegramMonitorPollingRuntime() {
	telegramMonitorPollingRuntimePromise ??= import("./monitor-polling.runtime-BSwOdP5A.js");
...
async function loadTelegramMonitorWebhookRuntime() {
	telegramMonitorWebhookRuntimePromise ??= import("./monitor-webhook.runtime-BxbprtH9.js");
