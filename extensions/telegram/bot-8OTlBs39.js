...
import { t as createTelegramThreadBindingManager } from "./thread-bindings-uXdpaDuY.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-DbKGqpw-.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BbIYdplp.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as defaultTelegramBotDeps, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands } from "./bot-deps-DEe_F2u9.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BBABDCGB.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BKGIvMhR.js").then((n) => n.p);
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-CJFTGEw2.js");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-DEe_F2u9.js").then((n) => n.t)).defaultTelegramBotDeps;
