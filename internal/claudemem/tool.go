...
// Tool is the read-only `claude_memory` jess tool. It exposes two
...
// Compile-time assertion that *Tool satisfies the jess tool.Tool
// interface. No agentcore dep — talon's chatdriver builds jess agents
// and registers jess tools directly.
...
// Description satisfies tool.Tool.
...
// Execute satisfies tool.Tool. A bad op, missing slug, or
